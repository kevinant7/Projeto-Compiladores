...
public class IsiLangParser extends Parser {
    ...
    public static class DeclaravarContext extends ParserRuleContext {
        ...
        public List<TerminalNode> ID() {
            return getTokens(IsiLangParser.ID);
        }
        ...
        public TerminalNode SC() {
            return getToken(IsiLangParser.SC, 0);
        }

        public List<TerminalNode> VIR() {
            return getTokens(IsiLangParser.VIR);
        }
    ...
    public static class CmdleituraContext extends ParserRuleContext {
        public TerminalNode AP() {
            return getToken(IsiLangParser.AP, 0);
        }

        public TerminalNode ID() {
            return getToken(IsiLangParser.ID, 0);
        }

        public TerminalNode FP() {
            return getToken(IsiLangParser.FP, 0);
        }
    ...
    public static class CmdattribContext extends ParserRuleContext {
        ...
        public TerminalNode ATTR() {
            return getToken(IsiLangParser.ATTR, 0);
        }
    ...
    public static class CmdselecaoContext extends ParserRuleContext {
        ...
        public TerminalNode OPREL() {
            return getToken(IsiLangParser.OPREL, 0);
        }
        ...
        public List<TerminalNode> ACH() {
            return getTokens(IsiLangParser.ACH);
        }
        ...
        public List<TerminalNode> FCH() {
            return getTokens(IsiLangParser.FCH);
        }
        ...
        public TerminalNode NUMBER() {
            return getToken(IsiLangParser.NUMBER, 0);
        }
    ...
    public static class ExprContext extends ParserRuleContext {
        ...
        public List<TerminalNode> OP() {
            return getTokens(IsiLangParser.OP);
        }
